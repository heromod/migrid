...
# --- BEGIN_HEADER ---
#
# magic - determines mime type for a file by magic numbers
...
magic.py
 ...
 To rebuild the magic numbers: uncomment the respective part in the
     file, run script, then paste contents of output file as 'magic'.
'''
...
magic = [
# added manually
        # PK Zip magic number: "PK" not consolidated, but common:
        [0L, 'string', '=', 'PK\003\004', 'application/zip'],
        [0L, 'string', '=', 'BZh', 'application/x-bzip2'],
        [0L, 'string', '=', 'BZ', 'application/x-bzip'],
# generated from a CentOS httpd magic file
        [0L, 'short', '=', 51966L, ''],
	[0L, 'string', '=', '.snd', ''],
	[0L, 'lelong', '=', 6583086L, ''],
	[8L, 'string', '=', 'AIFF', 'audio/x-aiff'],
	[8L, 'string', '=', 'AIFC', 'audio/x-aiff'],
	[8L, 'string', '=', '8SVX', 'audio/x-aiff'],
	[0L, 'string', '=', 'MThd', 'audio/unknown'],
	[0L, 'string', '=', 'CTMF', 'audio/unknown'],
	[0L, 'string', '=', 'SBI', 'audio/unknown'],
	[0L, 'string', '=', 'Creative Voice File', 'audio/unknown'],
	[0L, 'string', '=', 'RIFF', 'audio/unknown'],
	[0L, 'beshort', '=', 65520L, 'audio/mpeg'],
	[0L, 'string', '=', 'PSID', 'audio/prs.sid'],
	[0L, 'string', '=', '/* XPM', 'image/x-xbm 7bit'],
	[0L, 'string', '=', '/*', 'text/plain'],
	[0L, 'string', '=', '//', 'text/plain'],
	[0L, 'string', '=', '\x1f\x9d', 'application/octet-stream x-compress'],
	[0L, 'string', '=', '\x1f\x8b', 'application/octet-stream x-gzip'],
	[0L, 'string', '=', '\x1f\x1e', 'application/octet-stream'],
	[0L, 'short', '=', 17437L, 'application/octet-stream'],
	[0L, 'short', '=', 8191L, 'application/octet-stream'],
	[0L, 'string', '=', '\xff\x1f', 'application/octet-stream'],
	[0L, 'short', '=', 145405L, 'application/octet-stream'],
	[0L, 'string', '=', '<MakerFile', 'application/x-frame'],
	[0L, 'string', '=', '<MIFFile', 'application/x-frame'],
	[0L, 'string', '=', '<MakerDictionary', 'application/x-frame'],
	[0L, 'string', '=', '<MakerScreenFon', 'application/x-frame'],
	[0L, 'string', '=', '<MML', 'application/x-frame'],
	[0L, 'string', '=', '<Book', 'application/x-frame'],
	[0L, 'string', '=', '<Maker', 'application/x-frame'],
	...
	[0L, 'string', '=', '<HTML', 'text/html'],
	[0L, 'string', '=', '<!--', 'text/html'],
	[0L, 'string', '=', '<h1', 'text/html'],
	[0L, 'string', '=', '<H1', 'text/html'],
	[0L, 'string', '=', '<?xml', 'text/xml'],
	[0L, 'string', '=', 'P1', 'image/x-portable-bitmap 7bit'],
	[0L, 'string', '=', 'P2', 'image/x-portable-greymap 7bit'],
	[0L, 'string', '=', 'P3', 'image/x-portable-pixmap 7bit'],
	[0L, 'string', '=', 'P4', 'image/x-portable-bitmap'],
	[0L, 'string', '=', 'P5', 'image/x-portable-greymap'],
	[0L, 'string', '=', 'P6', 'image/x-portable-pixmap'],
	[0L, 'string', '=', 'IIN1', 'image/x-niff'],
	[0L, 'string', '=', 'MM', 'image/tiff'],
	[0L, 'string', '=', 'II', 'image/tiff'],
	[0L, 'string', '=', 'GIF94z', 'image/unknown'],
	[0L, 'string', '=', 'FGF95a', 'image/unknown'],
	[0L, 'string', '=', 'PBF', 'image/unknown'],
	[0L, 'string', '=', 'GIF', 'image/gif'],
	[0L, 'beshort', '=', 65496L, 'image/jpeg'],
	[0L, 'string', '=', 'BM', 'image/bmp'],
	[0L, 'string', '=', ';;', 'text/plain 8bit'],
	[0L, 'string', '=', '\n(', 'application/x-elc'],
	[0L, 'string', '=', ';ELC\x13\x00\x00\x00', 'application/x-elc'],
	[0L, 'string', '=', 'Relay-Version:', 'message/rfc822 7bit'],
	[0L, 'string', '=', '#! rnews', 'message/rfc822 7bit'],
	[0L, 'string', '=', 'N#! rnews', 'message/rfc822 7bit'],
	[0L, 'string', '=', 'Forward to', 'message/rfc822 7bit'],
	[0L, 'string', '=', 'Pipe to', 'message/rfc822 7bit'],
	[0L, 'string', '=', 'Return-Path:', 'message/rfc822 7bit'],
	[0L, 'string', '=', 'Path:', 'message/news 8bit'],
	[0L, 'string', '=', 'Xref:', 'message/news 8bit'],
	[0L, 'string', '=', 'From:', 'message/rfc822 7bit'],
	[0L, 'string', '=', 'Article', 'message/news 8bit'],
	[0L, 'string', '=', '\xfe7\x00#', 'application/msword'],
	[0L, 'string', '=', '\xdb\xa5-\x00\x00\x00', 'application/msword'],
	[0L, 'string', '=', '%!', 'application/postscript'],
	[0L, 'string', '=', '\x04%!', 'application/postscript'],
	[0L, 'string', '=', '%PDF-', 'application/pdf'],
	[38L, 'string', '=', 'Spreadsheet', 'application/x-sc'],
	[0L, 'string', '=', '\xf7\x02', 'application/x-dvi'],
	[0L, 'leshort', '=', 759L, 'application/x-dvi'],
	[0L, 'string', '=', '{\\\\rtf', 'application/rtf'],
	[0L, 'string', '=', '\x00\x00\x01\xb3', 'video/mpeg'],
	[0L, 'byte', '=', 1L, 'video/unknown'],
	[0L, 'byte', '=', 2L, 'video/unknown'],
	[4L, 'string', '=', 'moov', 'video/quicktime'],
	[4L, 'string', '=', 'mdat', 'video/quicktime'],
	[0L, 'string', '=', '\x89PNG\r', 'image/png'],
  ]

# this was the original magic data from the file online
magic_original = [
  ...
  for line in lines:
    if re.match(r'\s*#', line):
      ...
      if offset[0] == '(':
        ...
        last[level] = new
        l.append(new)
        print (offset, type, op, value, msg, mask)

# this test has been modified (now using string.printable)
def whatis(data):
  ...
  for c in data:
    if not c in string.printable:
      return 'data'
  # all printable ASCII, return plain
  return 'text/plain'
...
#### uncomment this to build new data from a magic file ####
# import sys
# load('/etc/httpd/conf/magic')
# f = open('out', 'w')
