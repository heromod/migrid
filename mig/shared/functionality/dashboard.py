...
def main(client_id, user_arguments_dict):
    ...
    dashboard_info = """
This is the entry page to a MiG prototype which uses ARC as a backend.<br>

At the time of writing, the prototype supports job information and 
resource discovery.  
""" % os.environ
    ...
    output_objects.append({'object_type': 'warning', 
                           'text': """
Keep in mind that the frontend prototype is connected to production systems!
                           """})
